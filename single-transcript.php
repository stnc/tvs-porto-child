      ...
      <div class="single-debate-content">
        <div class="row">
          <div
            ...
            <?php
            $tvsDebateMB_relatedDebateID = get_post_meta($debateID, 'tvsDebateMB_relatedDebateID', true);
                ...
                <div class="sidebar-content">
                  ...
                  <div class="featured-image" style="margin-bottom: 10px">
                    <?php if (has_post_thumbnail()): ?>
                      ...
                      ?>
                    <?php else: ?>
                      <?php $url = wp_get_attachment_url(get_post_thumbnail_id($debateID), 'full'); ?>
                  ...
                  <?php if ($tvsDebateMB_relatedDebateID != "0"): ?>
                    <?php
                    $tvsDebateCommonSettings = get_option('tvsDebate_CommonSettings');
                    $tvsDebateShowVideoSpeaker = $tvsDebateCommonSettings["ShowVideoSpeaker"];
