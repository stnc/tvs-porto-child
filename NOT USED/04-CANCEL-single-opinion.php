...
<div id="content" role="main" class="porto-single-page">
	...
	if ( have_posts() ) :
		...
		if ( 'opinion' == $post->post_type ) :

			if ( ! empty( $porto_settings['post-backto-blog'] ) ) :
				?>
				<?php /* translators: %s: Post archive name */ ?>
			<a class="inline-block m-b-md" href="<?php echo get_post_type_archive_link( 'opinion' ); ?>"><i class="fas fa-long-arrow-alt-<?php echo ( is_rtl() ? 'right p-r-xs' : 'left p-l-xs' ); ?>"></i> <?php echo sprintf( esc_html__( 'Back to %s', 'porto' ), porto_title_archive_name( 'opinion' ) ); ?></a><?php endif; ?>
			...
			if ( ! empty( $porto_settings['post-backto-blog'] ) ) :
				?>
				<?php /* translators: %s: Post archive name */ ?>
			<a class="inline-block m-t-md m-b-md" href="<?php echo get_post_type_archive_link( 'opinion' ); ?>"><i class="fas fa-long-arrow-alt-<?php echo ( is_rtl() ? 'right p-r-xs' : 'left p-l-xs' ); ?>"></i> <?php echo sprintf( esc_html__( 'Back to %s', 'porto' ), porto_title_archive_name( 'opinion' ) ); ?></a>
				<?php
			endif;
